...
abstract final class MapGraphData {
  ...
  static const MapGraph cashFlow = MapGraph(
    ...
    nodes: [
      MapNode(id: 'retail', x: 120, y: 80, label: 'Retail Sales', ar: 'مبيعات التجزئة', kind: MapNodeKind.income, sub: 'Channel', value: 642000),
      MapNode(id: 'wholesale', x: 120, y: 220, label: 'Wholesale', ar: 'مبيعات الجملة', kind: MapNodeKind.income, sub: 'Channel', value: 388000),
      MapNode(id: 'exports', x: 120, y: 360, label: 'GCC Exports', ar: 'صادرات الخليج', kind: MapNodeKind.income, sub: 'Channel', value: 214000),
      MapNode(id: 'services', x: 120, y: 500, label: 'Service Revenue', ar: 'إيرادات الخدمات', kind: MapNodeKind.income, sub: 'Channel', value: 96000),
      MapNode(id: 'company', x: 470, y: 290, label: 'GeniusLink Co.', ar: 'شركة جينيس لينك', kind: MapNodeKind.hub, sub: 'Operating entity', note: 'Primary operating entity. All channel revenue consolidates here before payables are settled and the surplus is retained.'),
      MapNode(id: 'suppliers', x: 840, y: 70, label: 'Suppliers', ar: 'الموردون', kind: MapNodeKind.expense, sub: 'Payable', value: 318000),
      MapNode(id: 'payroll', x: 840, y: 195, label: 'Payroll', ar: 'الرواتب', kind: MapNodeKind.expense, sub: 'Payable', value: 330000),
      MapNode(id: 'tax', x: 840, y: 320, label: 'VAT & Zakat', ar: 'الضريبة والزكاة', kind: MapNodeKind.expense, sub: 'Payable', value: 56000),
      MapNode(id: 'opex', x: 840, y: 445, label: 'Operating Exp.', ar: 'مصروفات تشغيل', kind: MapNodeKind.expense, sub: 'Payable', value: 144000),
      MapNode(id: 'retained', x: 840, y: 575, label: 'Retained Earnings', ar: 'أرباح محتجزة', kind: MapNodeKind.equity, sub: 'Equity', value: 230000),
    ],
    edges: [
      MapEdge(id: 'f1', from: 'retail', to: 'company', value: 642000, label: 'Revenue'),
      MapEdge(id: 'f2', from: 'wholesale', to: 'company', value: 388000, label: 'Revenue'),
      MapEdge(id: 'f3', from: 'exports', to: 'company', value: 214000, label: 'Revenue'),
      MapEdge(id: 'f4', from: 'services', to: 'company', value: 96000, label: 'Revenue'),
      MapEdge(id: 'f5', from: 'company', to: 'suppliers', value: 318000, label: 'Settles'),
      MapEdge(id: 'f6', from: 'company', to: 'payroll', value: 330000, label: 'Pays'),
      MapEdge(id: 'f7', from: 'company', to: 'tax', value: 56000, label: 'Remits'),
      MapEdge(id: 'f8', from: 'company', to: 'opex', value: 144000, label: 'Funds'),
      MapEdge(id: 'f9', from: 'company', to: 'retained', value: 230000, label: 'Retains'),
    ],
  );
